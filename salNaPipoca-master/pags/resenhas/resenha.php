...
?>
<article class="mb-3 col-sm-12 col-md-12 col-lg-8 col-xl-8 p-0" >
<img src="images\resenhas\materia\<?php echo $linha = fgets($arquivo, 1024); ?>" class="card-img" alt="<?php echo $linha = fgets($arquivo, 1024); ?>" class="w-100">
