<body>
    <div class="container bg-light">
        ...
        <div class="row">
            <!-- Primeira noticia -->
            <!-- http://www.adorocinema.com/noticias/filmes/noticia-151656/ -->
            ...
            <!-- Segunda noticia -->
            <!-- http://www.adorocinema.com/noticias/filmes/noticia-151663/ -->
            <div class="col-sm-12 col-md-4 p-0">
                <div class="card">
                    <div class="card-body">
                        <section class="pl-0 justify-content-center">
            ...
            <!-- Terceira noticia -->
            <!-- http://www.adorocinema.com/noticias/filmes/noticia-151630/ -->
            <div class="col-sm-12 col-md-4 p-0">
                <div class="card">
                    <div class="card-body">
                        <section class="pl-0 justify-content-center">
                            <div class="text-center d-none d-md-block d-lg-block d-xl-block">
                                <img src="images/noticias/n3-StarW-g.jpg" alt="Imagem que representa a terceira noticia">
                            </div>
                            <div class="float-left d-md-none d-lg-none d-xl-none mr-2">
        ...
        <div class="row">
            <!-- Quarta noticia -->
            <!-- http://www.adorocinema.com/noticias/filmes/noticia-151329/ -->
            <div class="col-sm-12 col-md-4 p-0">
                <div class="card">
                    <div class="card-body">
                        <section class="pl-0 justify-content-center">
                            <div class="text-center d-none d-md-block d-lg-block d-xl-block">
                                <img src="images/noticias/n4-Hollywood-g.jpg" alt="Imagem que representa a quarta noticia">
                            </div>
                            <div class="float-left d-md-none d-lg-none d-xl-none mr-2">
            ...
            <!-- Quinta noticia -->
            <!-- https://cinepop.com.br/animais-fantasticos-3-se-passara-no-brasil-e-sera-o-maior-filme-da-franquia-202068 -->
            <div class="col-sm-12 col-md-4 p-0">
                <div class="card">
                    <div class="card-body">
                        <section class="pl-0 justify-content-center">
            ...
            <!-- Sexta noticia -->
            <!-- https://entretenimento.uol.com.br/noticias/redacao/2019/10/14/coringa-lidera-bilheterias-no-brasil-mais-uma-vez.htm -->
            <div class="col-sm-12 col-md-4 p-0">
                <div class="card">
                    <div class="card-body">
                        <section class="pl-0 justify-content-center">
                            <div class="text-center d-none d-md-block d-lg-block d-xl-block">
                                <img src="images/noticias/n6-Coringa-g.jpg" alt="Imagem que representa a primeira noticia">
                            </div>
                            <div class="float-left d-md-none d-lg-none d-xl-none mr-2">
